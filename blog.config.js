...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'fd341e1fc73b42ee9a5b4ef20dc4a909',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'gcoo.io', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'gcoo.io', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.gcoo.io', // 网站地址
  ...
  FONT_SANS: [// 无衬线字体 例如'LXGW WenKai'
    'Pretendard Variable', 'pretendard', '-apple-system', 'BlinkMacSystemFont', '"Hiragino Sans GB"',
  ...
  FONT_SERIF: [// 衬线字体 例如'LXGW WenKai'
    'Pretendard Variable', '"Noto Serif SC"', 'SimSun', '"Times New Roman"', 'Times', 'serif',
  ...
  BACKGROUND_DARK: '#2F3437', // use hex value, don't forget '#'
  ...
  SEO_GOOGLE_SITE_VERIFICATION: process.env.NEXT_PUBLIC_SEO_GOOGLE_SITE_VERIFICATION || 'gnai4tfM88eq1saILB4p0aFb_Bt1Tjp1iu28CPcx-lM', // Remove the value or replace it with your own google site verification code
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '지쿠터 포스트', // 站点标题 ，被notion中的页面标题覆盖
